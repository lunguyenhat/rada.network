          ...
          <div className="mt-4">
            <div className="flex flex-wrap xl:flex-nowrap items-center w-full">
              ...
              <div className="flex flex-col flex-shrink-0 flex-0 mb-4">
                <div className="pricing">
                  ...
                  <span
                    ...
                    type={usdCoinInfo?.AggregatedData?.CHANGE24HOUR > 0 ? "up" : "down"}
                  >
                    <i
                      className={`fa-solid fa-caret-${
                        usdCoinInfo?.AggregatedData?.CHANGE24HOUR > 0 ? "up" : "down"
                      } mr-1`}
                    ></i>
                ...
                <div className="pricing pricing-sm mt-2">
                  ...
                  >
                    <i
                      className={`fa-solid fa-caret-${
                        btcCoinInfo?.AggregatedData?.CHANGE24HOUR > 0 ? "up" : "down"
                      } mr-1`}
                    ></i>
              ...
              <div className="flex flex-wrap md:flex-nowrap w-full lg:ml-6 lg:space-x-2 lg:divide-x divide-gray-400 divide-opacity-20">
                ...
                <div className="lg:text-center pr-4 lg:pr-0 lg:w-full">
                  <div className="field-label">
                    <span className="field-label--text" title="Circulating Supply">
                      C. Supply
                    </span>
                  </div>
                  <div className="mb-2">
                    ...
                    <strong href="#" className="">
                      {numberFormatter(
                        usdCoinInfo?.AggregatedData?.SUPPLY ||
                          parseInt(
                            tokenData?.total_supply?.replaceAll(",", "").replaceAll(".", "")
                          ) ||
                          0,
                        {
                          notation: "compact",
          ...
          <div className="mt-4">
            <div className="flex w-full">
              <div className="text-sm w-full">
                {tokenData?.link?.find(
                  (item) => item.group !== null && item.group.toLowerCase() === "homepage"
                ) && (
                  <div className="field">
                    <div className="field-label">
                ...
                {tokenData?.contract_address && (
                  <div className="field">
                    ...
                    <div className="">
                      <CopyToClipboard onCopy={handleCopy} text={tokenData?.contract_address}>
                        <a href="#" className="btn btn-default btn-default-sm">
                          ...
                          <span className="btn--text">{`${tokenData?.contract_address.substr(
                            0,
                            6
                          )}...${tokenData?.contract_address.substr(-6)} `}</span>
                          <span className="icon">
                ...
                {tokenData?.link?.find(
                  (item) => item.group === "whitepaper" || item.group === "tokenomic"
                ) && (
                  <div className="field">
                    <div className="field-label">
