            ...
            <div className="page page-full scrollbar">
              <div className="page-full--inner">
                ...
                <div className="page-section pb-8">
                  ...
                  <div className="card card-pagecontent">
                    <div className="card-header">
                      <span className="card-title">Contribution (required)</span>
                    </div>
                      ...
                      <div className="list-group">
                        <div className="list-group--item !justify-start !items-start">
                          ...
                          <div>
                            ...
                            <ol className="">
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Follow our
                                Twitter{" "}
                                <a
                                  className="link"
                              ...
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Subscribe
                                to our{" "}
                                <a
                                  className="link"
                              ...
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Join our{" "}
                                <a
                                  className="link"
                        ...
                        <div className="list-group--item !justify-start !items-start">
                          ...
                          <div>
                            ...
                            <ul className="grid grid-cols-1 w-full">
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Have at
                                least 1 post on FB group
                              </li>
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Commit at
                                least 1 commit to our Rada Github
                              </li>
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Contribute
                                a design
                              </li>
                              <li className="mb-1">
                                <i className="fa-solid fa-check text-green-400 mr-2"></i> Invite at
                                least 100 people to Rada
                              </li>
                              <li className="mb-1">
