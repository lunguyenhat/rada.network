                ...
                <div className="flex w-full">
                  <div className="text-sm w-full">
                    ...
                    <div className="flex flex-wrap justify-between mb-2">
                      ...
                      <div className="">14 December, 2021</div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-between mb-2">
                      <div className="w-full lg:w-auto">
                        <span className="uppercase opacity-50 text-2xs md:text-xs">Status</span>
                      </div>
                      <div className="label label--active">Open for investment</div>
                      {/*
                  ...
                  <div className="card--body">
                    ...
                    <div className="step--wrapper">
                      <div className="step--header flex">
                        ...
                        <h3>
                          Send <span className="font-semibold dark:text-white">USDT </span> to
                          RADA&rsquo;s Treasury Wallet
                        </h3>
