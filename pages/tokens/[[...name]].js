...
const Token = observer((props) => {
  ...
  return (
    ...
    <div className={`body-decor--text`}>
      ...
      {props.sub === "" ? (
        <TokenDetail props={props} dataStore={dataStore} detailStore={detailStore} />
      ) : (
        ""
      )}
      {props.sub === "events" ? (
        <TokenEvents props={props} dataStore={dataStore} detailStore={detailStore} />
      ) : (
        ""
      )}
      {props.sub === "team" ? (
        <TokenTeam props={props} dataStore={dataStore} detailStore={detailStore} />
      ) : (
        ""
      )}
      {props.sub === "market" ? (
        <TokenMarket props={props} dataStore={dataStore} detailStore={detailStore} />
      ) : (
        ""
      )}
    </>
          ...
          <div className="pane-content">
            <div className="pane-content--main">
              <div className="bg-gray-200 flex flex-col h-full w-full justify-center items-center">
                ...
                <span className="text-sm bg-opacity-50">For showing Placeholder UI only</span>
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-1">
                      ...
                      <div className="w-full mt-4">
                        ...
                        <div className="post-content mt-8">
                          ...
                          <p>
                            Axie Infinity is a blockchain-based trading and battling game that is
                            partially owned and operated by its players.
                          </p>

                          <p>
                            Inspired by popular games like Pokémon and Tamagotchi, Axie Infinity
                            allows players to collect, breed, raise, battle and trade token-based
                            creatures known as Axies.
                          </p>

                          <p>
                            These Axies can take various forms, and there are more than 500
                            different body parts available, including aquatic, beast, bird, bug,
                            plant and reptile parts. Parts from each type class come in four
                            different rarity scales: common, rare, ultra rare and legendary — and
                            Axies can have any combination of body parts, making them highly
                          ...
                          <p>
                            Each Axie is a non-fungible token (NFT) with different attributes and
                            strengths and can be entered into 3v3 battles, with the winning team
                            earning more experience (exp) points that are used to level up an Axie's
                            stats or evolve their body parts. These Axies can be bred together to
                            produce new and unique offspring, which can be used or sold on the Axie
                            marketplace.
                          </p>

                          <p>
                            The Axie Infinity ecosystem also has its own unique governance token,
                            known as Axie Infinity Shards (AXS). These are used to participate in
                            key governance votes and will give holders a say in how funds in the
                            Axie Community Treasury are spent.
                          </p>
                      ...
                      <div>
                        ...
                        <div className="w-full mt-8">
                          ...
                          <div className="post-content mt-8">
                            ...
                            <p>
                              To learn more about this project, check out our deep dive of Axie
                              Infinity.
                            </p>
                            ...
                            <p>
                              Each Axie is a non-fungible token (NFT) with different attributes and
                              strengths and can be entered into 3v3 battles, with the winning team
                              earning more experience (exp) points that are used to level up an
                              Axie's stats or evolve their body parts. These Axies can be bred
                              together to produce new and unique offspring, which can be used or
        ...
        <div className="pane-center--main">
          <div className="pane-content">
            ...
            <div className="pane-content--sec pane-content-active">
              ...
              {/* Main Content */}
              <div className="pane-content--sec--main grid scrollbar">
                <div className="page page-coininfo">Token team</div>
              </div>
              {/* END: Main Content */}
            </div>
          </div>
        ...
        <div className="pane-center--main">
          <div className="pane-content">
            ...
            <div className="pane-content--sec pane-content-active">
              ...
              {/* Main Content */}
              <div className="pane-content--sec--main grid scrollbar">
                <div className="page page-coininfo">Token Event</div>
              </div>
              {/* END: Main Content */}
            </div>
          </div>
          ...
          <div className="tabbar page-tabs">
            ...
            <a href="#" className={"tab-item" + (props.sub === "market"? " tab-item--active" : "") }>
              ...
              <Link href={`/tokens/` + props.token + "/team"}>
                <a
                  href="#"
                  className={"tab-item" + (props.sub === "team" ? " tab-item--active" : "")}
                >
                  Team &amp; Partners
                </a>
              </Link>
