        ...
        <>
          <h3 className="text-2xl text-center mb-8 font-normal">
            <span className="text-color-title">
              Danh sách đăng ký mua {project.token.name} sẽ được mở trong
            </span>
          </h3>
    ...
    <>
      <div className="test">
        ...
        <p className="text-sm text-center mt-8 leading-7">
          <span className="text-color-desc">Bạn vui lòng chờ cho đến khi danh sách được mở!</span>
          <br />
          <span className="text-color-desc">Bạn cần đăng ký để tham gia mua.</span>
          <br />
