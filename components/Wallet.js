              ...
              <div className={`inline-block w-full z-200 relative dialog`}>
                <div className={`dialog-wrapper`}>
                  ...
                  <div className={`dialog_header ${styles.dialog_header_wrapper}`}>
                    <Dialog.Title as="div" className={`${styles.dialog_header}`}>
                      <button
                        type="button"
                          ...
                          <li ref={btnRef}>
                            ...
                            >
                              <span className={`icon ${styles.btn_icon}`}>
                                <img
                                  src={
                                    process.env.NEXT_PUBLIC_CDN + "/images/icons/metamask-24.png"
                                  }
                                  alt="Metamask - Secure wallets with great flexibility"
                                />
                              </span>
                          ...
                          <li>
                            <a
                              ...
                              onClick={() => {
                                ...
                                setActivatingConnector(setActivatingConnector(walletconnect));
                              }}
                            >
                              <span className={`icon ${styles.btn_icon}`}>
                                <img
                                  src={
                                    ...
                                    "/images/icons/walletconnect-24.png"
                                  }
                                  alt="WalletConnect - Connect with Rainbow, Trust, Argent..."
                                />
                              </span>
                              <div className={`${styles.btn_text}`}>
                                <span className="text-base font-semibold text-color-title">
    ...
    <div className="list-group--item md:!pb-4">
      ...
      <div className="flex-1 md:mt-0">
        <div className="relative pl-8 md:pl-0 w-full flex items-center">
          {_.isEmpty(account) ? (
            ...
            <>
              <div>
                <strong>{`${account.substr(0, 6)}...${account.substr(-4)} `}</strong>
              </div>
              <strong></strong>
              {store.network == "bsc" ? (
      ...
      <div className="text-right -mt-2 md:mt-0">
        {_.isEmpty(account) ? (
          <>
            <NetworkSwitch />
            <button className="btn btn-default" onClick={handleConnectWallet}>
              {t("connect")}
            </button>
          </>
        ) : (
          <button className="btn btn-default" onClick={() => handleDisconnectWallet()}>
            {t("disconnect")}
          </button>
        )}
      </div>
