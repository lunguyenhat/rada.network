  ...
  return (
    <svg className="rada-svg" viewBox="4 4 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill="#fff"
      ></path>
      <circle className="inline-circle" cx="20" cy="7" r="3" fill="#374151"></circle>
      <circle className="inline-circle" cx="20" cy="33" r="3" fill="#374151"></circle>
      <circle
