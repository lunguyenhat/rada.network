                    ...
                    <div className="flex flex-wrap md:flex-nowrap w-full md:space-x-2 md:divide-x divide-gray-400 divide-opacity-20">
                      <div className="md:text-center pr-8 md:pr-0 md:w-1/2 lg:w-full">
                        <div className="w-full lg:w-auto">
                          <span className="uppercase opacity-50 text-2xs md:text-xs">Location</span>
                        </div>
                        <div className="mb-2">
                          <strong className="">Vietnam</strong>
                        </div>
                      </div>

                      <div className="md:text-center pr-8 md:pr-0 md:w-1/2 lg:w-full">
                        <div className="w-full lg:w-auto">
                          <span className="uppercase opacity-50 text-2xs md:text-xs">Founded</span>
                        </div>
                        <div className="mb-2">
                          <strong className="">2018</strong>
                        </div>
                      </div>
                      ...
                      <div className="md:text-center pr-8 md:pr-0 md:w-1/2 lg:w-full">
                        ...
                        <div className="mb-2">
                          <strong className="">Series A</strong>
                        </div>
                      </div>
                      ...
                      <div className="md:text-center md:w-1/2 lg:w-full">
                        ...
                        <div className="mb-2">
                          <a href="https://skymavis.com/" rel="nofollow" target="_blank">
                            <strong className="">Sky Mavis</strong>
                    ...
                    <div className="card card-team">
                      ...
                      <div className="card-body">
                        ...
                        <div className="card-body-main">
                          <p className="">
                            Trung Nguyen is CEO of Sky Mavis. He is an entrepreneur who started 5
                            years on Wall Street in 2007 and left to create an open source community
